...
public class ChatChannelHandler extends SimpleChannelInboundHandler<ByteBuf> {
    final private static ChannelGroup channelGroup = new DefaultChannelGroup(GlobalEventExecutor.INSTANCE);
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ByteBuf msg) throws Exception {
        ...
        channelGroup.forEach(channel1 -> {
            if (channel == channel1) {
                channel1.writeAndFlush("self: " + msg.toString(CharsetUtil.UTF_8));
            } else {
